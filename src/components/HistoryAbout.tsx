      ...
      <div className='max-w-[92%] md:max-w-[96%] mx-auto'>
        ...
        <div className='flex justify-between items-center mt-16 md:mt-28 gap-12 md:gap-16 md:flex-row flex-col'>
          ...
          <div className='md:w-[50%]'>
            ...
            <Button className="w-[200px] px-6 text-white font-bold rounded-sm h-[60px] text-center bg-black hover:bg-transparent hover:text-black border border-black" name="Explore Products" link='/shop' divStyle='mt-8' />
          </div>
        </div>
      </div>
    </section>
